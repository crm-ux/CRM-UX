...
class SaleQuotePreviewWizard(models.TransientModel):
    ...
    def _rebuild_document_html(self):
        ...
        table_html = (
            ...
            '</thead>'
            '<tbody>%s'
            '<tr><td colspan="7" style="text-align:right;border:1px solid #ddd;padding:6px 8px;background:#f9f9f9;"><b>Total Amount:</b> %s</td></tr>'
            '<tr><td colspan="7" style="text-align:right;border:1px solid #ddd;padding:6px 8px;background:#f9f9f9;"><b>Discount Amount:</b> %s</td></tr>'
            '<tr><td colspan="7" style="text-align:right;border:2px solid #2c3e50;padding:6px 8px;background:#eaf0fb;font-size:13px;"><b>Net Total Amount:</b> %s</td></tr>'
            '</tbody>'
            '</table>'
