...
class SaleQuotePreviewWizard(models.TransientModel):
    ...
    def _rebuild_document_html(self):
        ...
        table_html = (
            ...
            '</thead>'
            '<tbody>%s'
            '<tr><td colspan="6" style="text-align:right;border:1px solid #ddd;padding:6px 8px;"><b>Total Amount:</b></td><td style="text-align:right;border:1px solid #ddd;padding:6px 8px;"><b>%s</b></td></tr>'
            '<tr><td colspan="6" style="text-align:right;border:1px solid #ddd;padding:6px 8px;"><b>Discount Amount:</b></td><td style="text-align:right;border:1px solid #ddd;padding:6px 8px;"><b>%s</b></td></tr>'
            '<tr><td colspan="6" style="text-align:right;border:1px solid #ddd;padding:6px 8px;font-size:13px;"><b>Net Total Amount:</b></td><td style="text-align:right;border:1px solid #ddd;padding:6px 8px;font-size:13px;"><b>%s</b></td></tr>'
            '</tbody>'
            '</table>'
