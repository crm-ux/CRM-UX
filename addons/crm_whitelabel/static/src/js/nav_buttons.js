                    ...
                    setTimeout(() => {
                        ...
                        if (targetContainer) {
                            targetContainer.innerHTML = `
                                <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:80vh; width:100%; text-align:center; padding:clamp(1.5rem, 4vh, 3rem); font-family:inherit; background-color:#ffffff; background-image:radial-gradient(circle at 50% 50%, #cbd5e1 clamp(0.06rem, 0.1vw, 0.08rem), transparent clamp(0.06rem, 0.1vw, 0.08rem)); background-size:clamp(1.2rem, 2vw, 1.6rem) clamp(1.2rem, 2vw, 1.6rem); -webkit-mask-image:radial-gradient(circle at 50% 50%, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 40%, rgba(0,0,0,0) 70%); mask-image:radial-gradient(circle at 50% 50%, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 40%, rgba(0,0,0,0) 70%);">
