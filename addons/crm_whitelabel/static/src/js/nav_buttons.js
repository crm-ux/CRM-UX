                    ...
                    setTimeout(() => {
                        ...
                        if (targetContainer) {
                            targetContainer.innerHTML = `
                                <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; height:100vh; min-height:100vh; width:100%; text-align:center; padding:0 clamp(1.5rem, 3vw, 2.5rem); font-family:inherit; background-color:#ffffff; background-image:radial-gradient(circle at 50% 50%, rgba(224, 242, 254, 0.6) 0%, rgba(240, 249, 255, 0.2) 20vh, transparent 38vh), radial-gradient(circle at 50% 50%, #475569 clamp(0.05rem, 0.08vw, 0.07rem), transparent clamp(0.05rem, 0.08vw, 0.07rem)); background-size:100% 100%, clamp(1.1rem, 1.8vw, 1.4rem) clamp(1.1rem, 1.8vw, 1.4rem); -webkit-mask-image:radial-gradient(circle at 50% 50%, rgba(0,0,0,1) 0%, rgba(0,0,0,0.85) 18vh, transparent 38vh); mask-image:radial-gradient(circle at 50% 50%, rgba(0,0,0,1) 0%, rgba(0,0,0,0.85) 18vh, transparent 38vh); box-sizing:border-box;">
