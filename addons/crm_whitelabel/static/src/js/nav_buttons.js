                    ...
                    setTimeout(() => {
                        ...
                        if (targetContainer) {
                            targetContainer.innerHTML = `
                                <div style="display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:80vh; width:100%; text-align:center; padding:clamp(1.5rem, 4vh, 3rem); font-family:inherit; background-color:#ffffff; background-image:radial-gradient(circle at 50% 50%, rgba(239, 68, 68, 0.25) 0%, rgba(239, 68, 68, 0.12) 40%, rgba(239, 68, 68, 0) 70%), radial-gradient(circle at 50% 50%, #ef4444 clamp(0.06rem, 0.1vw, 0.09rem), transparent clamp(0.06rem, 0.1vw, 0.09rem)); background-size:100% 100%, clamp(1.2rem, 2vw, 1.6rem) clamp(1.2rem, 2vw, 1.6rem); background-repeat:no-repeat, repeat; -webkit-mask-image:radial-gradient(circle at 50% 50%, #000 0%, #000 45%, transparent 70%); mask-image:radial-gradient(circle at 50% 50%, #000 0%, #000 45%, transparent 70%);">
